...
async def generate_pdf(html_content: str) -> bytes:
    ...
    try:
        ...
        # Add TOC items for major sections (in a real implementation, this would be more sophisticated)
        pdf_gen.add_toc_item("Executive Summary", 1, 1)
        pdf_gen.add_toc_item("Price Trends", 2, 2)
        pdf_gen.add_toc_item("Forward Curves", 2, 3)
        pdf_gen.add_toc_item("Correlation Analysis", 2, 4)
        pdf_gen.add_toc_item("Detailed Data", 2, 5)

        return pdf_gen.to_pdf(html_content)
