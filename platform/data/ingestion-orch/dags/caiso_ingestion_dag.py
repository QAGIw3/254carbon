"""
CAISO Real-Time and Day-Ahead LMP Ingestion DAG
Scheduled to run every 5 minutes for RTM, hourly for DAM.
...
def check_caiso_data_quality(**context):
    ...
    events_processed = ti.xcom_pull(task_ids='ingest_caiso_rtm', key='events_processed')
