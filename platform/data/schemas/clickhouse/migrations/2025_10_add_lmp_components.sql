...
--   event_time_utc DateTime64(3),
--   instrument_id String,
--   location_code String,
--   price_type String,
--   value Decimal(10,4),
--   volume Nullable(Decimal(12,4)),
--   currency String,
--   unit String,
--   source String,
--   energy_component Nullable(Decimal(10,4)),
--   congestion_component Nullable(Decimal(10,4)),
--   loss_component Nullable(Decimal(10,4))
-- )
-- ENGINE = Kafka
