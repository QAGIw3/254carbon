...
class AESOConnector(Ingestor):
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.api_base = config.get("api_base", "http://ets.aeso.ca/api")
        self.data_type = config.get("data_type", "POOL")  # POOL, AIL, INTERTIE, FORECAST
    ...
    def _fetch_alberta_internal_load(self) -> Iterator[Dict[str, Any]]:
        """
        Fetch Alberta Internal Load (AIL).
