...
Purpose
-------
Detects and publishes cross-market arbitrage signals, exposes analytics for
spreads and profitability, and integrates optionally with Kafka and Prometheus
for streaming and metrics.
"""
...
try:
    ...
    try:
        from routers.data_quality_framework import DataQualityFramework
    except Exception:
        try:
